...
-- relation
BEGIN;
INSERT INTO `relation`(`name`, `isDefault`) VALUES ('亲戚', '1');
...
-- CREATE TABLE `participant_${banquetID}`  (
--   `id` int(15) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
--   `name` varchar(63) NULL,
--   `amount` float NULL,
--   `relation_id` int(0) NULL,
--   `relation_name` varchar(63) NULL,
--   `gift_id` int(0) NULL,
--   `gift_name` varchar(63) NULL,
--   `note` text NULL,
--   `create_date` datetime(0) NULL,
--   `update` datetime(0) NULL,
--   `deleted` char(1) NOT NULL DEFAULT '0',
--   PRIMARY KEY (`id`)
-- );